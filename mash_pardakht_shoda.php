                    ...
                    <div class="card fat" style="">
                        <div class="card-body">
                            <button class="glyphicon print glyphicon-circle-arrow-left text text-primary" id="icon"
                                style="font-size:25px;" onclick="window.open('salary.php','_self');"></button>
                            ...
                            <h2 class="card-title b_font" style="text-align:center; "> معاشات پرداخت شده </h2>
                            ...
                            <button class="btn btn-primary print btn-sm" style="margin-top:36px;"
                                onclick="window.open('mash_pardakht_shoda.php','_self')"><img
                            ...
                            <table class="table table-bordered table-striped" id="dokakin_sab_shoda" dir="rtl">
                                ...
                                <tbody id="tbody">
                                    ...
                                    if(isset($_POST["search_btn_submit"])){
                                        ...
                                        // echo "-------------------------";
                                        // echo $to_sh . " - " . $to_m;
                                        $sql_query_02 = mysqli_query($connection,"select * from pardakht_mash where date_m between '$from_m' and '$to_m'");
                                        $sql_query_03 = mysqli_query($connection,"select sum(salary) as salary,sum(bardasht) as bardasht,sum(salary-bardasht) as total from pardakht_mash where date_m between '$from_m' and '$to_m'");
                                    }
                                    else{
                                        $sql_query_02 = mysqli_query($connection,"select * from pardakht_mash");
                                        $sql_query_03 = mysqli_query($connection,"select sum(salary) as salary,sum(bardasht) as bardasht,sum(salary-bardasht) as total from pardakht_mash");
                                ...
                                ?>
                                    <tr style="">
                                        ...
                                        <td class=""><?php echo $fetch_02["salary"];?></td>
                                        <td class=""><?php echo $fetch_02["bardasht"];?></td>
                                        <td class=""><?php echo $fetch_02["salary"]-$fetch_02["bardasht"];?></td>

                                        <td class="b_font"><?php echo $fetch_02["paid"];?></td>
                                        <td class="b_font"><?php echo $fetch_02["description"];?></td>

                                        <td><?php echo $fetch_02["date_sh"];?></td>
                                        <td class="b_font author40per" id="icon">

                                            <a href="edit.php?pa_id=<?php echo  $fetch_02["id"];?>"><span
                    ...
                    ?>
                                    <tr class="bg bg-primary">
                                        <th colspan="4"> مجموع مقدار : <span class="" style="font-size:15px;"><?php
                                                ...
                                                echo $fetch_03["salary"]; ?></span>
                                        </th>
                                        <th colspan="4"> مجموع برداشت : <span class="" style="font-size:15px;"><?php
                                                
                                                echo $fetch_03["bardasht"]; ?></span>
                                        </th>
                                        <th colspan="4"> مجموع قابل پرداخت : <span class="" style="font-size:15px;"><?php
                                                
                                                echo $fetch_03["total"]; ?></span>
                                        </th>
...
function delet(id) {
    ...
    if (confirm == true) {
        window.open("delete.php?pa_id=" + id, "_self");
    } else {
