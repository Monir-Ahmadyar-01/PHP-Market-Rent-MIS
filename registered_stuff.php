        ...
        <section class="h-100" style=" padding:0px !important;">
            <div class="container-fluid h-100">
                <div class="card-wrapper" style="width:100%;margin-top:1%; ">
                    <div class="card fat" style="">
                        <div class="card-body">
                            <button class="glyphicon print glyphicon-circle-arrow-left text text-primary" id="icon"
                                ...
                                onclick="window.open('stuff_registeration.php','_self');"></button>
                            ...
                            <button class="btn btn-primary print btn-sm" style="margin-top:36px;"
                                onclick="window.open('registered_stuff.php','_self')"><img
                            ...
                            <table class="table table-bordered table-striped" id="dokakin_sab_shoda" dir="rtl">
                                <thead>
                                    ...
                                    <tr class="bg bg-primary">
                                        ...
                                        <th class="b_font print">اسکن تذکره</th>
                                ...
                                <tbody id="tbody">
                                    ...
                                    if(isset($_POST["search_btn_submit"])){
                                        ...
                                        // echo "-------------------------";
                                        // echo $to_sh . " - " . $to_m;
                                        $sql_query_02 = mysqli_query($connection,"select * from sabt_karmandan where date_m between '$from_m' and '$to_m'");
                                        ...
                                        $sql_query_02 = mysqli_query($connection,"select * from sabt_karmandan");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="b_font"><?php echo $fetch_02["work_area"];?></td>
                                        <td class="b_font"><?php echo $fetch_02["nawyat"];?></td>
                                        <td><?php echo $fetch_02["salary"];?></td>
                                        <td><?php echo $fetch_02["email"];?></td>
                                        <td class=""><?php echo $fetch_02["phone"];?></td>
                                        <td class="b_font"><?php echo $fetch_02["home"];?></td>
                                        <td class="b_font print">
                                            <img src="stuff_images/<?php echo $fetch_02["photo"];?>"
                                                style="height:50px; width:50px;" class="img img-thumbnail" alt="">
                                        </td>
                                        <td class="b_font print">
                                            <a class="b_font" target="_blank"
                                                href="stuff_id/<?php echo $fetch_02["tazkira"];?>"><?php if ($fetch_02["tazkira"] != "") {
                                                echo "تذکره ضمیمه شده";
                                        ...
                                        <td class="b_font" id="icon">
                                            ...
                                            <a href="edit.php?id_r_s=<?php echo  $fetch_02["id"];?>"><span
                    ...
                    ?>
                                    <tr class="bg bg-primary">
                                        <th colspan="14"> مجموع معاش : <span class="" style="font-size:15px;"><?php
...
function delet(id) {
    ...
    if (confirm == true) {
        window.open("delete.php?id_r_s=" + id, "_self");
    } else {
