            ...
            <div class="container-fluid h-100">
                <div class="card-wrapper" style="width:100%;margin-top:1%; ">
                    <div class="card fat" style="">
                        <div class="card-body">
                            <button class="glyphicon glyphicon-circle-arrow-left text text-primary" id="icon"
                                style="font-size:25px;"
                                onclick="window.open('bardakht_karmandan.php','_self');"></button>
                            ...
                            <h2 class="card-title b_font" style="text-align:center; "> برداشت های انجام شده </h2>
                            ...
                            <button class="btn btn-primary btn-sm" style="margin-top:36px;"
                                onclick="window.open('bardasht_ha.php','_self')"><img
                            ...
                            <table class="table table-bordered table-striped" id="dokakin_sab_shoda" dir="rtl">
                                ...
                                <tbody id="tbody">
                                    ...
                                    if(isset($_POST["search_btn_submit"])){
                                        ...
                                        // echo "-------------------------";
                                        // echo $to_sh . " - " . $to_m;
                                        $sql_query_02 = mysqli_query($connection,"select * from bardasht_karmandan where date_m between '$from_m' and '$to_m'");
                                        $sql_query_03 = mysqli_query($connection,"select sum(amount) as amount from bardasht_karmandan where date_m between '$from_m' and '$to_m'");
                                    }
                                    else{
                                        $sql_query_02 = mysqli_query($connection,"select * from bardasht_karmandan");
                                        $sql_query_03 = mysqli_query($connection,"select sum(amount) as amount from bardasht_karmandan");
...
function delet(id) {
    ...
    if (confirm == true) {
        window.open("delete.php?ba_ha=" + id, "_self");
    } else {
